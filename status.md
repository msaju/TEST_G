...
[![Nightly RPM Build Status](https://ci.centos.org/buildStatus/icon?job=gluster_nightly-rpm-builds&subject=Nightly RPM Build Status)](https://ci.centos.org/view/Gluster/job/gluster_nightly-rpm-builds/)
