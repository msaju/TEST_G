...
[![Nightly RPM Build Status](https://ci.centos.org/buildStatus/icon?subject=Nightly RPM Build Status job=gluster_nightly-rpm-builds)](https://ci.centos.org/view/Gluster/job/gluster_nightly-rpm-builds/)
